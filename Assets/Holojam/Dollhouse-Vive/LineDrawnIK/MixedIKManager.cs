...
public class MixedIKManager : MonoBehaviour {
	...
	void scaleConstants () {
		LimbWidth *= globalScale;
		LowerLimbWidth *= globalScale;
		headOffset *= globalScale;
		handOffset *= globalScale;
		footOffset *= globalScale;
		SpineOffset *= globalScale;
		kneeScale *= globalScale;
		elbowScale *= globalScale;
		minimumMidOffset *= globalScale;
		maximumMidOffset *= globalScale;
		upperArmLength *= globalScale;
		lowerArmLength *= globalScale;
	}
